...
public class RawGitHubFetcher implements Runnable{
    private final File targetFile;
    private final String url;
    private static boolean shutdown=false;

    private RawGitHubFetcher(File targetFile, String url) {
    ...
    public RawGitHubFetcher(){
        this(
                Config.getRagVersionsFile(),
                "https://raw.githubusercontent.com/psilo-hub/jSlideGen/refs/heads/main/src/main/resources/jChatRAG.txt"
        );
    }
        ...
        while (!success) {
            ...
            if (data != null) {
                try {
                    ...
                    System.out.println(data.length + " bytes written to " + targetFile);
                    success = true;
                    Config.getInstance().setLuc();
                } catch (IOException e) {
